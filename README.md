...
## Bibtex
If you would like to refer to this software in your publication, please use the following entry:
```
@misc{haugo19fraktal,
    author = {Simen Haugo},
    year = {2019},
    note = {https://github.com/lightbits/fraktal},
    title = {{fraktal}: A library for function-based inverse procedural modeling.}
}
```
